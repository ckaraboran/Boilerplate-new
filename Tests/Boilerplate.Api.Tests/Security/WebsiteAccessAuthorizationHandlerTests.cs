...
public class WebsiteAccessAuthorizationHandlerTests
{
    ...
    [Fact]
    public async Task Given_UserManagerRequirement_When_UserAuthorized_ThenShouldBeSuccessful()
    {
        //Arrange    
        var requirements = new[] { new UserManagerRequirement() };
        var user = new ClaimsPrincipal(
            new ClaimsIdentity(
                new[]
                {
    ...
    [Fact]
    public async Task Given_UserManagerRequirement_When_UserCannotManageUsers_ThenShouldFail()
    {
        //Arrange    
        var requirements = new[] { new UserManagerRequirement() };
        var user = new ClaimsPrincipal(
    ...
    [Fact]
    public async Task Given_UserManagerRequirement_When_UserNotKnown_ThenShouldFail()
    {
        //Arrange    
        var requirements = new[] { new UserManagerRequirement() };
        var user = new ClaimsPrincipal();
